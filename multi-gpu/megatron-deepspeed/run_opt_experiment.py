...
from utils import (add_model_hooks, remove_model_hooks, cache_bytes,
                   get_filename, hidden_bytes,model_bytes, write_benchmark_log, get_prompts)
from packaging import version
from Configurator import Configurator, ModelGetter
...
def run_generation(
    ...
    prompts = get_prompts(args.data_dir)
